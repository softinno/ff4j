...
public final class FF4jSwaggerConfiguration {
    ...
    static {
        ...
        beanConfig.setTitle("Feature Flipping for Java (ff4j)");
        beanConfig.setDescription("Expose ff4j operations through a secured REST API.");
        beanConfig.setResourcePackage("org.ff4j.api.resources");
        beanConfig.setVersion(FF4jSwaggerConfiguration.class.getPackage().getImplementationVersion());
