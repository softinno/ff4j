...
public class FeatureStoreResource extends AbstractResource {
    ...
    public FeatureStoreApiBean get() {
        return new FeatureStoreApiBean(ff4j.getFeatureRepository());
    }
    ...
    public List < FeatureApiBean> readFeatures() {
        Feature[] storeContent = getFeatureRepository().readAll().values().toArray(new Feature[0]);
    ...
    public List < GroupDescApiBean > readGroups() {
        Map< String, Feature > features = getFeatureRepository().readAll();
    ...
    public FeatureStoreApiBean createSchema() {
        getFeatureRepository().createSchema();
        return new FeatureStoreApiBean(ff4j.getFeatureRepository());
    }
    ...
    public Response getStatus() {
        ...
        return Response.ok(new CacheApiBean(getFeatureRepository())).build();
    }
