...
public class WebConstants {
    ...
    public static final String PERMISSION_GRANTEE_NAME = "granteeName";
    public static final String PERMISSION_GRANTEE_USER = "user";
    public static final String PERMISSION_GRANTEE_ROLE = "role";
