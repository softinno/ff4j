...
public class XmlParserV2Test implements FF4jTestDataSet {
    ...
    public void testPropertiesParsing() throws IOException {
        ...
        Assert.assertEquals(f.getProperties().get("ppint").getValueAsInt(), 12);
        Assert.assertEquals(f.getProperties().get("ppdouble").getValueAsDouble(), 12.5,0);
        Assert.assertEquals(f.getProperties().get("ppboolean").getValueAsBoolean(),true);
        Assert.assertEquals(f.getProperties().get("ppstring").getValueAsString(), "hello");
        Assert.assertEquals(f.getProperties().get("regionIdentifier").getValueAsString(), "AMER");
