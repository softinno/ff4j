...
import static org.ff4j.core.test.AssertUtils.assertHasLengthParam;
import static org.ff4j.core.test.AssertUtils.assertNotNullParam;
 ...
 */
public abstract class FF4jConfigurationParser {
    ...
    protected static Map < String, FF4jConfiguration > cachedConfiguration = new HashMap<>();
     ...
     *      configuration bean
     */
    public FF4jConfiguration parse(String fileName) {
        assertHasLengthParam("fileName", 0, fileName);
        if (!cachedConfiguration.containsKey(fileName)) {
            InputStream xmlIN = FF4jConfigurationParser.class.getClassLoader().getResourceAsStream(fileName);
     ...
     *      configuration bean
     */
    public void export(FF4jConfiguration config, String targetFile) {
     ...
     *      configuration bean
     */
    public abstract FF4jConfiguration parse(InputStream inputStream);
     ...
     *      configuration bean
     */
    public abstract String export(FF4jConfiguration config);
