package org.ff4j.core.exception;
...
public class NotFoundException extends RuntimeException {
    ...
    /** error message. */
    private static final String ERROR_MESSAGE = "Entity id {%s} does not exist in store";
     ...
     *            feature to be processed
     **/
    public NotFoundException(String entityId, Throwable parentException) {
