...
import org.ff4j.core.jdbc.JdbcSchema.FeatureHitColumns;
...
import org.ff4j.core.jdbc.JdbcSchema.PropertyColumns;
import org.ff4j.core.jdbc.JdbcSchema.RolesColumns;
import org.ff4j.core.jdbc.JdbcSchema.RolesPermissionColumns;
import org.ff4j.core.jdbc.JdbcSchema.SQLTypes;
import org.ff4j.core.jdbc.JdbcSchema.SqlTableColumns;
import org.ff4j.core.jdbc.JdbcSchema.UsersColumns;
import org.ff4j.core.jdbc.JdbcSchema.UsersPermissionColumns;
import org.ff4j.core.jdbc.JdbcSchema.UsersRolesColumns;
...
public class JdbcQueryBuilder {
    ...
    public String sqlCreateSchema() {
        return new StringBuilder()
                ...
                .append(sqlCreateTableFeatureHit())
    ...
    public String getTableNameFeaturePermission() {
	    return getTableName(FeaturePermissionColumns.FEATURE_UID.tableName());
	}
	// create
    ...
    public String sqlDropTableFeaturePermission() {
        return sqlDropTable(FeaturePermissionColumns.FEATURE_UID.tableName());
    }
    // insert
    ...
    public String sqlDeleteFeaturePermission() {
        return sqlDeleteWhere(FeaturePermissionColumns.FEATURE_UID, FeaturePermissionColumns.PERMISSION);
    }
    // delete all for a feature 
    public String sqlDeleteAllFeaturePermissionForFeature() {
        return sqlDeleteWhere(FeaturePermissionColumns.FEATURE_UID);
    }
    // delete all 
    public String sqlDeleteAllFeaturePermission() {
        return sqlDeleteAll(FeaturePermissionColumns.FEATURE_UID);
    }
    // select *
    ...
    public String sqlSelectPermissionsOfFeature() {
        return sqlSelectWhere(false, FeaturePermissionColumns.FEATURE_UID, FeaturePermissionColumns.values());
    }
    ...
    public String sqlCreateTableToggleStrategyProperties() {
        ...
        sb.append(FeatureToggleStrategyPropertiesColumns.FEATURE_UID.colname() + ",");
        sb.append(FeatureToggleStrategyPropertiesColumns.TOGGLESTRATEGY_CLASSNAME.colname());
    ...
    public String sqlSelectToggleStrategiesPropOfFeature() {
        return sqlSelectWhere(false, FeatureToggleStrategyPropertiesColumns.FEATURE_UID, 
                FeatureToggleStrategyPropertiesColumns.values());
    }
    // delete
    public String sqlDeleteAllToggleStrategyPropertiesForFeature() {
        return sqlDeleteWhere(FeatureToggleStrategyPropertiesColumns.FEATURE_UID);
    }
    // delete for a toggle strategy
    public String sqlDeleteToggleStrategyPropertiesForToggleStrategy() {
        return sqlDeleteWhere(
                FeatureToggleStrategyPropertiesColumns.FEATURE_UID,
                FeatureToggleStrategyPropertiesColumns.TOGGLESTRATEGY_CLASSNAME);
    }
    // delete
	...
	public String getTableNameFeatureProperties() {
	    return getTableName(FeaturePropertyColumns.FEATURE_UID.tableName());
	}
	// create
    ...
    public String sqlDeleteAllPropertiesFromFeature() {
        return sqlDeleteWhere(FeaturePropertyColumns.FEATURE_UID);
    }
    // select *
    ...
    public String sqlSelectPropertiesForFeature() {
        return sqlSelectWhere(false, FeaturePropertyColumns.FEATURE_UID, FeaturePropertyColumns.values());
    }
    ...
    // select by id
    public String sqlFindFeatureHitById() {
       return sqlSelectWhere(false, FeatureHitColumns.UID, FeatureHitColumns.values());
    }
    // select all
    public String sqlFindAllFeatureHitId() {
        return sqlSelect(false, FeatureHitColumns.UID);
    }
    // select al;;
    public String sqlSelectAllFeatureHit() {
        return sqlSelect(false, FeatureHitColumns.values());
    }
    // delete all audit trail
    public String sqlDeleteAllFeatureHit() {
        return sqlDeleteAll(FeatureHitColumns.UID);
    }
    // exist
    public String sqlExistFeatureHit() {
        return sqlCountWhere(FeatureHitColumns.UID, FeatureHitColumns.UID);
    }
    // tablename
    public String getTableNameFeatureHit() {
        return getTableName(FeatureHitColumns.UID.tableName());
    }
    // create
    public String sqlCreateTableFeatureHit() {
        return sqlCreateTable(FeatureHitColumns.values());
    }
    // drop
    public String sqlDropTableFeatureHit() {
        return sqlDropTable(FeatureHitColumns.UID.tableName());
    }
    // insert
    public String sqlInsertFeatureHit() {
        return sqlInsert(FeatureHitColumns.values());
    }
    // delete
    public String sqlDeleteFeatureHit() {
        return sqlDeleteWhere(FeatureHitColumns.UID);
    }
    
    public String sqlHitCount(FeatureHitColumns dimension) {
        StringBuilder sb = new StringBuilder();
        sb.append("SELECT count(" + FeatureHitColumns.UID.colname() + ") as NB, " + dimension.colname() + " FROM ");
        sb.append(getTableName(FeatureHitColumns.UID.tableName()));
        sb.append(" WHERE   (" + FeatureHitColumns.TIMESTAMP.colname() + "> ?) ");
        sb.append(" AND   (" + FeatureHitColumns.TIMESTAMP.colname() + "< ?)");
        sb.append(" GROUP BY " + dimension.colname());
        return sb.toString();
    }
    ...
    public String getTableNameRoles() {
        return getTableName(RolesColumns.UID.tableName());
    }
    // create
    ...
    public String sqlDropTableRoles() {
        return sqlDropTable(RolesColumns.UID.tableName());
    }
    // insert
    public String sqlInsertRole() {
    ...
    public String sqlCountRoles() {
        return sqlCount(RolesColumns.UID);
    }
    // select by id
    public String sqlSelectRoleByName() {
        return sqlSelectWhere(false, RolesColumns.UID, RolesColumns.values());
    }
    // delete
    public String sqlDeleteRole() {
        return sqlDeleteWhere(RolesColumns.UID);
    }
    // delete all
    public String sqlDeleteAllRoles() {
        return sqlDeleteAll(RolesColumns.UID);
    }
    ...
    // exist
    public String sqlExistRole() {
        return sqlCountWhere(RolesColumns.UID, RolesColumns.UID);
    }
    // tablename
    ...
    // delete all item for 
    public String sqlDeleteRoleInRoleUsers() {
        return sqlDeleteWhere(UsersRolesColumns.REF_ROLE);
    }
    // delete all item for 
    public String sqlDeleteUserInRoleUsers() {
        return sqlDeleteWhere(UsersRolesColumns.REF_USER);
    }
    ...
    public String sqlSelectAllAudit() {
        return sqlSelect(false, AuditTrailColumns.values());
    }
    // delete all audit trail
