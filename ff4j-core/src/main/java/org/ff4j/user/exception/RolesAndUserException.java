 ...
 */
public class RolesAndUserException extends RepositoryAccessException {
     ...
     *            Exception message
     **/
    public RolesAndUserException(String msg) {
        super(msg);
    }
     ...
     * 
     **/
    public RolesAndUserException(String msg, Throwable parent) {
        super(msg, parent);
    }
