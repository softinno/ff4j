 ...
 */
public interface FeatureHitRepository extends FF4jRepository < String, Event > {
     ...
     *      a list of events
     */
    EventSeries search(FeatureHitQuery query);
     ...
     *      end time
     */
    void purge(FeatureHitQuery query);
     ...
     * @return
     */
    Map < String, HitCount > getHitCount(FeatureHitQuery query);
     ...
     * return the hitcount
     */
    Map < String, HitCount > getHostHitCount(FeatureHitQuery query);
     ...
     * return the hitcount
     */
    Map < String, HitCount > getUserHitCount(FeatureHitQuery query);
     ...
     * return the hitcount
     */
    Map < String, HitCount > getSourceHitCount(FeatureHitQuery query);
     ...
     *      object structure
     */
    TimeSeries getFeatureUsageHistory(FeatureHitQuery query, TimeUnit units);
     ...
     */
    default int getTotalHitCount(FeatureHitQuery query) {
