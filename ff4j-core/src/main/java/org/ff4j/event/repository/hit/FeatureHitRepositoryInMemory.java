 ...
 */
public class FeatureHitRepositoryInMemory extends FeatureHitRepositorySupport {
     ...
     */
    public FeatureHitRepositoryInMemory() {
     ...
     */
    public FeatureHitRepositoryInMemory(int queueCapacity) {
    ...
    /** {@inheritDoc} */
    @Override
    public void purge(FeatureHitQuery q) {
    ...
    private void addAllMatchingEvents(EventSeries result, EventSeries current, FeatureHitQuery query) {
