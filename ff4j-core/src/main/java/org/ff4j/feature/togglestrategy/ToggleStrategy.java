 ...
 */
public interface ToggleStrategy extends Predicate< ToggleContext > {
     ...
     */
    public static ToggleStrategy of(String uid, String className, Set <Property<?>> params) {
        try {
            ToggleStrategy strategy = (ToggleStrategy) 
    ...
    public static ToggleStrategy of(String uid, String className,  Stream<Property<?>> params) {
