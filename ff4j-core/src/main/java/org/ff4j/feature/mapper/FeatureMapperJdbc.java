package org.ff4j.feature.mapper;
 ...
 */
public class FeatureMapperJdbc extends JdbcMapper implements FeatureMapper< PreparedStatement, ResultSet > {
     ...
     *      query builder
     */
    public FeatureMapperJdbc(Connection sqlConn, JdbcQueryBuilder qbd) {
        super(sqlConn, qbd);
    }
